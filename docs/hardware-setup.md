...
- Monitor 2 (bawah / operator): untuk **panel admin/operator**. Buka:
  - `/operator` untuk petugas loket (ADMIN) memanggil/recall/skip/serve.
  - `/admin` (Filament) hanya untuk SUPER_ADMIN konfigurasi (setting organisasi, loket, layanan, pengumuman, role, audit).
