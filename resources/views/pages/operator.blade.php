...
<div class="max-w-5xl mx-auto px-6 py-10">
  <div class="flex items-start justify-between gap-6">
    <div>
      <p class="text-sm text-slate-500">Perumdam Tirta Perwira Kabupaten Purbalingga</p>
      <h1 class="text-2xl md:text-3xl font-semibold mt-1">Operator Loket</h1>
      <p class="text-slate-600 mt-2">Panggil antrian sesuai loket yang ditugaskan.</p>
    </div>

    <div class="flex items-center gap-2">
      <a href="/display" class="px-4 py-2 rounded-xl border border-slate-200 hover:bg-slate-50">Display</a>
      <a href="/" class="px-4 py-2 rounded-xl border border-slate-200 hover:bg-slate-50">Landing</a>
    </div>
  </div>
  ...
  <div class="mt-8 rounded-2xl bg-white border border-slate-200 p-6 shadow-sm">
    ...
    <form method="POST" action="/operator/login" class="mt-5 grid gap-3 max-w-md">
      ...
      <p class="text-xs text-slate-500">
        Demo: operator@perumdam.test / password
      </p>
    </form>
  </div>
  @endguest
